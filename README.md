...
无需下载或登录。支持电脑与手机，首次访问默认简体中文。个人手记保存在当前浏览器中。

网站通过 GitHub Pages 托管；主分支的网站内容更新后，自动构建、检查并发布。
...
新闻快照是历史记录，不代表当前事实。联网更新须主动运行服务或更新工具；静态网页本身不会抓取外部订阅源。GitHub Pages 部署配置位于 `.github/workflows/pages.yml`。在线版使用仓库中的新闻快照；定时抓取模板保留在 `docs/examples/news-and-pages.yml`，未启用定时抓取。
